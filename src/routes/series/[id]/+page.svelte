          ...
          {#each episodes as ep, i}
            ...
            >
              <div class="relative aspect-video overflow-hidden rounded-card bg-surface-2 transition group-select:ring-2 group-select:ring-brand">
                <img src={ep.background} alt={ep.title} loading="lazy" class="h-full w-full object-cover transition-transform duration-150 group-select:scale-105" />
              ...
              <div class="line-clamp-1 text-sm font-bold">{ep.title}</div>
